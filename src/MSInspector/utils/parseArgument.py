...
\n'.format('###############################################################################'.ljust(len('usage:')))
	usage = usageTmp+'Usage: MSInspector [-h] [<args>]\n\nExample 1:\nMSInspector -ps "C:\Program Files\SkylineDailyRunner\SkylineDailyRunner.exe"  -pr "C:\Program Files\R\R-3.3.1\\bin\Rscript.exe" -i "D:\Skyline_analysis\qcAssayPortal\data\UVicPC_Borchers-MousePlasma_Agilent6490_directMRM-Exp1\20160309_MouseV2B1.5_refined_2018-07-03_14-59-18.sky.zip" -e exp1 -t "D:\Skyline_analysis\qcAssayPortal\data\UVicPC_Borchers-MousePlasma_Agilent6490_directMRM-Exp1\meta_data.tsv"\nExample 2:\nMSInspector -ps "C:\Program Files\Skyline\SkylineCmd.exe" -pr "C:\Program Files\R\R-3.3.1\\bin\Rscript.exe" -i "D:\Skyline_analysis\qcAssayPortal\data\UVicPC_Borchers-MousePlasma_Agilent6490_directMRM-Exp2" -e exp2\n'
