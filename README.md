...
The work flow of MSInspector is shown [here](../src/MSInspector/doc/workflow.pdf).
...
The details of the errors and warnings are listed [here](../src/MSInspector/doc/issue_categories.pdf).
